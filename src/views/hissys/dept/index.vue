<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="当前挂号量" prop="deptNum">
        <el-input
          v-model="queryParams.deptNum"
          placeholder="请输入当前挂号量"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
        />
      ...
      <el-form-item label="手机号码" prop="deptPhone">
        <el-input
          v-model="queryParams.deptPhone"
          placeholder="请输入手机号码"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
    ...
    <el-table v-loading="loading" :data="deptList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="手机号码" align="center" prop="deptPhone"/>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="当前挂号量" prop="deptNum">
          <el-input v-model="form.deptNum" placeholder="请输入当前挂号量"/>
        </el-form-item>
        <el-form-item label="负责人" prop="deptLeader">
          <el-input v-model="form.deptLeader" placeholder="请输入负责人"/>
        </el-form-item>
        <el-form-item label="手机号码" prop="deptPhone">
...
<script>
import { listDept, getDept, delDept, addDept, updateDept, exportDept } from '@/api/hissys/dept'
